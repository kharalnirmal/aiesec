      ...
      <div className="relative mx-auto w-full">
        <div className="relative flex flex-row justify-between items-center">
          ...
          <div className="z-10 relative flex flex-1 justify-center items-center px-2 sm:px-4 md:px-8 text-center">
            ...
            <div
              className="relative flex justify-center items-center bg-gradient-to-r from-blue-50 via-white to-blue-50 shadow-lg px-6 sm:px-8 md:px-12 lg:px-16 w-full h-32 sm:h-40 md:h-4 lg:h-50"
              style={{
                clipPath:
